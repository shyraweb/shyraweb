...
const DeleteElement = dynamic(
  () => import("@/components/Editor/Properties/DeleteElement")
);
const EditorElementContent = dynamic(
  () => import("@/components/Editor/Properties/EditorElementContent")
);
const TailwindClassWrapper = dynamic(
  () => import("@/components/Editor/Properties/TailwindClassWrapper")
);
